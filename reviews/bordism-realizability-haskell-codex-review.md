...
Note: round-3's single High finding (sqrt-of-negative-rounding NaN) was fixed post-cap with a clamp + pinned reproducer check, self-verified by rebuild and run.
